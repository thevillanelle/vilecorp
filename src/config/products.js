...
export const PRODUCTS = [
  ...
  },
  {
    ...
    price: '$45',
    badge: null,
    description: 'How to finesse, flourish, and f*ing win in New York City. Neighborhoods, social circles, dating, and the mindset that makes the city yours. Go further with Ritualwhere.',
    cta: 'Get the Guide',
    type: 'stripe',
